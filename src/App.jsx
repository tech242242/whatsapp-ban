    ...
    <div className="landing-overlay">
      <div className="whatsapp-loader">
        ...
        <div className="loading-text">
          ...
          <p>Welcome, Saqib! Loading recovery tool...</p>
...
const WelcomeSaqib = () => {
  ...
  return (
    <div className="support-tools-container">
      <h2 className="tools-title">Quick Support Tools</h2>
      <p className="tools-subtitle">Select a tool to begin process</p>
    ...
    <div className="min-h-screen bg-gradient-to-b from-gray-50 to-white">
      ...
      <div className="flex items-center justify-center min-h-screen p-4">
        <div className="w-full max-w-4xl">
                ...
                <div className="flex items-center space-x-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-600">
                      Powered by Saqib's Recovery Tools
                    </p>
                  </div>
                </div>
          ...
          {/* Welcome Section */}
          <div className="bg-white shadow border rounded-xl mt-4 p-6">
            <WelcomeSaqib />
            <SupportTools />
          </div>
